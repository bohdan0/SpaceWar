...
/***/ function(module, exports, __webpack_require__) {
	...
	class Game {
	  ...
	  drawBackground(ctx) {
	    ...
	    // gradient.addColorStop(0, '#01010d');
	    // gradient.addColorStop(1, '#040f2b');
	    // ctx.fillStyle = gradient;
	    // ctx.fillRect(0, 0, this.DIM_X, this.DIM_Y / 2);

	    // gradient = ctx.createLinearGradient(0, 400, 0, 800);
	    // gradient.addColorStop(0, '#040f2b');
	    // gradient.addColorStop(1, '#01010d');
	    // ctx.fillStyle = gradient;
	    // ctx.fillRect(0, this.DIM_Y / 2, this.DIM_X, this.DIM_Y);

	    let gradient = ctx.createRadialGradient(800, 550, 0, 800, 550, 800);
...
/***/ function(module, exports, __webpack_require__) {
	...
	class Ship extends MovingObject {
	  ...
	  setProtection() {
	    this.protect = true;
	    setInterval(() => {this.protect = false;}, 3000);
	  }
