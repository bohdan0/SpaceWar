...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener('DOMContentLoaded', () => {
	  ...
	  document.getElementById('mute').addEventListener('click', () => {
	    audio.main.paused ? audio.main.play() : audio.main.pause();
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	class GameView {
	  ...
	  start() {
	    ...
	    setInterval(() => {
	      let asteroid = this.game.asteroids[Math.floor(Math.random()*this.game.asteroids.length)];
	      asteroid.fireBullet();
	    }, 1000);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	class MovingObject {
	  ...
	  explode() {
	    this.game.audio.explosion.cloneNode().play();
...
/***/ function(module, exports, __webpack_require__) {
	...
	class Ship extends MovingObject {
	  ...
	  fireBullet() {
	    this.game.audio.shot.cloneNode().play();
