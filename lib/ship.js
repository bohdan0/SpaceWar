...
class Ship extends MovingObject {
  constructor(options = {}) {
    ...
    this.maxPos = [600 - this.radius * 2, 800 - this.radius * 2];
  }
  ...
  bounce() {
    this.vel = [0, 0];
    if (this.pos[0] < this.minPos[0]) {
      this.pos[0] = this.minPos[0];
    } else if (this.pos[1] < this.minPos[1]) {
      this.pos[1] = this.minPos[1];
    } else if (this.pos[0] > this.maxPos[0]) {
      this.pos[0] = this.maxPos[0];
    } else if (this.pos[1] > this.maxPos[1]) {
